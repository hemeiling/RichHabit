...
export const zh: Dict = {
  ...
  priorities: {
    ...
    quadrants: {
      unsorted: { title: "待分类", subtitle: "放进合适的象限", short: "规划" },
      urgent_important: { title: "紧急且重要", subtitle: "马上做", short: "马上做" },
      urgent_not_important: { title: "紧急但不重要", subtitle: "委托或快速处理", short: "委托" },
      important_not_urgent: { title: "重要但不紧急", subtitle: "规划和安排", short: "规划" },
      not_important_not_urgent: { title: "不重要且不紧急", subtitle: "以后做或删除", short: "以后" },
    },
