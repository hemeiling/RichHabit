...
export const en = {
  ...
  aiWorkspace: {
    ...
    emptyBody: "Write, plan, review, or ask about a file you attach. This workspace can't see anyone's RichHabit data.",
    starters: [
      "Draft a short update for early users",
      "Review a plan and list the risks",
      "Summarise an attached document",
    ...
    disclosure: {
      ...
      body: [
        "Files you upload are stored in RichHabit. When you attach one to a message, it is sent to Anthropic, the company behind Claude, so the model can read it.",
        "Anthropic keeps uploaded files until they are deleted, and they are not covered by zero data retention.",
        "Upload only what you are comfortable sharing with Anthropic, and never other people's private information.",
      ],
