...
-- tests/ai-workspace-migration.test.ts compares the two. Nothing in this section
-- references or changes any table above except users, for ownership.
...
create index ai_projects_owner_idx
...
create index ai_conversations_recent_idx
...
create index ai_message_files_file_idx
  on ai_message_files (file_id);

create table ai_file_provider_copies (
